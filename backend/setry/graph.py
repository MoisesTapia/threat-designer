...
class ReactAgent:
    def __init__(
        ...
        self.llm = model
        self.tools = tools or []
        self.prompt = prompt or "You are a helpful AI assistant with vision capabilities."
    ...
    def _preprocess_messages_for_image(
        ...
        if isinstance(first_message, HumanMessage):
            ...
            # Handle list content
                ...
                if not isinstance(first_block, dict) or first_block.get("type") != "image_url":
                    new_content = [
                        {
                            "type": "image_url",
                            "image_url": {"url": image_data}
    ...
    def _agent_node(
        ...
        if image_data:
            state_messages = self._preprocess_messages_for_image(state_messages, image_data)
