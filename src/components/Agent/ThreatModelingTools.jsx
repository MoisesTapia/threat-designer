...
const ThreatModelingTools = React.memo(({ toolName, content, toolStart, error, isParentFirstMount }) => { 
    ...
    const messageCount = parsedContent ? 
      (Array.isArray(parsedContent) ? parsedContent.length : Object.keys(parsedContent).length) : 0;
    ...
    return (
      <ToolContent
        ...
        children={<ListComponent threats={parsedContent} />}
      />
    );
  });
